  ...
  return (
    <div className='relative'>
      ...
      className={`w-full px-4 pt-6 pb-2 border rounded-xl transition-all duration-300 outline-none resize-none ${
        isDarkMode ? 'bg-gray-800/50 border-gray-700 text-white focus:border-blue-500 focus:bg-gray-800/70 ' : 'bg-whit/80 border-gray-300 text-gray-900 focus:border-blue-500 focus:bg-white'
      }`}
      value={value}
