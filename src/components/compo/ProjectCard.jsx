...
const ProjectCard = ({ project, index, isDarkMode }) => {
  ...
  return (
    ...
    >
      <div
        className={`rounded-2xl overflow-hidden border transition-all duration-500 h-90 ${
          isDarkMode
            ? "bg-gray-900 border-gray-800 hover:border-gray-700 hover:shadow-2xl hover:shadow-blue-500/10"
      ...
      >
        ...
        <div className="relative overflow-hidden">
          ...
          {/* Hover Overlay */}
          <motion.div
            className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 flex items-center justify-center space-x-4 transition duration-300"
          >
            {/* Live Demo Button */}
            <motion.a
        ...
        <div className="p-6">
          ...
          <p className={`text-sm leading-relaxed  mb-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>{project.description}</p>
          {/* tech stack tag */}
